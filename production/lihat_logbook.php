...
<!-- /top navigation -->
      ...
      <div class="right_col" role="main">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <table class="table table-striped table-bordered">
              ...
              <?php if($row->tujuan_merubah_perilaku=='F (Efficient & Effective)'){ ?>
                <tr>
                  <td><strong><span class="fa fa-check-circle"></span>&ensp;F (Efficient & Effective)</strong>
                  <?php if($row->target_flyhi0!==''){
                    echo '<br>Target: &ensp;1. '.$row->target_flyhi0.' '.$satuan_flyhi0;
                  }if($row->target_flyhi1!==''){
                    echo '<br>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;2. '.$row->target_flyhi1.' '.$satuan_flyhi1;
                  }if($row->target_flyhi2!==''){
                    echo '<br>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;3. '.$row->target_flyhi2.' '.$satuan_flyhi2;
                  }if($row->target_flyhi3!==''){
                    echo '<br>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;4. '.$row->target_flyhi3.' '.$satuan_flyhi3;
                  }
                  ?></td></tr>
                <tr>
              ...
              <?php }elseif($row->tujuan_merubah_perilaku=='L (Loyalty)'){ ?>
                ...
                <tr>
                  <td><strong><span class="fa fa-check-circle"></span>&ensp;L (Loyalty)</strong>
                  <?php if($row->target_flyhi0!==''){
                    echo '<br>Target: &ensp;1. '.$row->target_flyhi0.' '.$satuan_flyhi0;
                  }if($row->target_flyhi1!==''){
                    echo '<br>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;2. '.$row->target_flyhi1.' '.$satuan_flyhi1;
              ...
              <?php }elseif($row->tujuan_merubah_perilaku=='Y (Customer Centricity)'){ ?>
                ...
                <tr> 
                  <td><strong><span class="fa fa-check-circle"></span>&ensp;Y (Customer Centricity)</strong>
                  <?php if($row->target_flyhi0!==''){
                    echo '<br>Target: &ensp;1. '.$row->target_flyhi0.' '.$satuan_flyhi0;
                  }if($row->target_flyhi1!==''){
                    echo '<br>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;2. '.$row->target_flyhi1.' '.$satuan_flyhi1;
              ...
              <?php }elseif($row->tujuan_merubah_perilaku=='H (Honesty & Openness)'){ ?>
                ...
                <tr>
                  <td><strong><span class="fa fa-check-circle"></span>&ensp;H (Honesty & Openness)</strong>
                  <?php if($row->target_flyhi0!==''){
                    echo '<br>Target: &ensp;1. '.$row->target_flyhi0.' '.$satuan_flyhi0;
                  }if($row->target_flyhi1!==''){
                    echo '<br>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;2. '.$row->target_flyhi1.' '.$satuan_flyhi1;
              ...
              <tr>
                ...
                <?php 
                  if ($row->aktifitas0!=='') {
                    echo '<tr><td>1.&ensp;'.$row->aktifitas0.' | '.$row->target0.' '.$satuan0.'</td></tr>';
                  }
                  if($row->aktifitas1!=='') {
                    echo '<tr><td>2.&ensp;'.$row->aktifitas1.' | '.$row->target1.' '.$satuan1.'</td></tr>';
                  }
                  if($row->aktifitas2!=='') {
                    echo '<tr><td>3.&ensp;'.$row->aktifitas2.' | '.$row->target2.' '.$satuan2.'</td></tr>';
                  }
                  if($row->aktifitas3!=='') {
                    echo '<tr><td>4.&ensp;'.$row->aktifitas3.' | '.$row->target3.' '.$satuan3.'</td></tr>';
                  }
                  if($row->aktifitas4!=='') {
                    echo '<tr><td>5.&ensp;'.$row->aktifitas4.' | '.$row->target4.' '.$satuan4.'</td></tr>';
                  }
                ?>
              </tr>   
              <tr>
                ...
                if ($row->target_financial0!=='') {
                  echo '<br>Target: 1.&ensp;'.$row->target_financial0.' '.$row->satuan_financial0;
                }
                ...
                if ($row->target_customer0!=='') {
                  echo '<br>Target: 1.&ensp;'.$row->target_customer0.' '.$row->satuan_customer0;
                }
                ...
                if ($row->target_ibp0!=='') {
                  echo '<br>Target: 1.&ensp;'.$row->target_ibp0.' '.$row->satuan_ibp0;
                }
                if ($row->target_ibp1!=='') {
                ...
                if ($row->target_lg0!=='') {
                  echo '<br>Target: 1.&ensp;'.$row->target_lg0.' '.$row->satuan_lg0;
                }
                if ($row->target_lg1!=='') {
          ...
          <table class="table table-striped table-bordered">
              <tr>
                <th colspan="3" class="center"><h4>Attachment</h4></th>
              </tr>
              <tr>
                <?php
                if ($row->file!=='' && $row->size>0) {
                echo '<td><a href="user/uploads/'.$row->file.'"><i class="fa fa-cloud-download"></i> '.$row->file.'</a></td>';
                }else{
                  echo '<td>-</td>';
                }
                ?>
